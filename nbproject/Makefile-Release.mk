...
${OBJECTDIR}/Audio/src/CAudioOut.o: Audio/src/CAudioOut.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Audio/src/CAudioOut.o Audio/src/CAudioOut.cpp
...
${OBJECTDIR}/RadioProtocols/Shoutcast/src/CShoutcastStrategy.o: RadioProtocols/Shoutcast/src/CShoutcastStrategy.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RadioProtocols/Shoutcast/src/CShoutcastStrategy.o RadioProtocols/Shoutcast/src/CShoutcastStrategy.cpp

${OBJECTDIR}/TcpIp/src/CTcpServer.o: TcpIp/src/CTcpServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/TcpIp/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TcpIp/src/CTcpServer.o TcpIp/src/CTcpServer.cpp

${OBJECTDIR}/Http/src/CHttpClient.o: Http/src/CHttpClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/Http/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Http/src/CHttpClient.o Http/src/CHttpClient.cpp

${OBJECTDIR}/Audio/src/CAudioHw.o: Audio/src/CAudioHw.cpp 
	${MKDIR} -p ${OBJECTDIR}/Audio/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Audio/src/CAudioHw.o Audio/src/CAudioHw.cpp
...
${OBJECTDIR}/LinuxImpl/RadioProtocol/File/src/CFileStrategy.o: LinuxImpl/RadioProtocol/File/src/CFileStrategy.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/LinuxImpl/RadioProtocol/File/src/CFileStrategy.o LinuxImpl/RadioProtocol/File/src/CFileStrategy.cpp

${OBJECTDIR}/DataReceiver/src/CDataReceiver.o: DataReceiver/src/CDataReceiver.cpp 
	${MKDIR} -p ${OBJECTDIR}/DataReceiver/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataReceiver/src/CDataReceiver.o DataReceiver/src/CDataReceiver.cpp

${OBJECTDIR}/TcpIp/src/CTcpClient.o: TcpIp/src/CTcpClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/TcpIp/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TcpIp/src/CTcpClient.o TcpIp/src/CTcpClient.cpp

${OBJECTDIR}/Audio/src/CAudioHwNotConfigured.o: Audio/src/CAudioHwNotConfigured.cpp 
	${MKDIR} -p ${OBJECTDIR}/Audio/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Audio/src/CAudioHwNotConfigured.o Audio/src/CAudioHwNotConfigured.cpp
